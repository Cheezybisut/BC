...
function C010_Revenge_Intro_Run() {
	...
	DrawImage(ctx, CurrentChapter + "/" + CurrentScreen + "/Background.jpg", -200, 0);

	// Amanda or Sarah intro
	if ((Common_PlayerCrime == "AmandaStranded") || (Common_PlayerCrime == "SarahStranded")) {
		DrawImage(ctx, CurrentChapter + "/" + CurrentScreen + "/AmandaSarah.jpg", 800, 0);	
	...
	if ((Common_PlayerCrime == "SidneyStranded") || (Common_PlayerCrime == "JenniferStranded")) {
		DrawImage(ctx, CurrentChapter + "/" + CurrentScreen + "/SidneyJennifer.jpg", 800, 0);
